...
export default function RecalibrateControl({ api }: { api: VersionsApi }) {
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex items-center justify-between gap-2">
        {/* Kept, deliberately: the button produces mocked output, and a control
            that generates fake results without saying so is the one piece of
            copy this pad cannot afford to lose. */}
        <span className="font-jetbrains text-[10px] text-white/30">simulated · re-weights only</span>
        {n > 0 && (
          <button
