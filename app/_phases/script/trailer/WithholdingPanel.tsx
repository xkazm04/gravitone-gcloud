        ...
        {budget.assets.map((a) => {
          ...
          return (
            <li key={a.id} data-testid={`asset-${a.id}`} className="border-t border-white/8 pt-3 first:border-t-0 first:pt-0">
              <p className="font-jetbrains text-[10px] tracking-[0.14em] text-white/35 uppercase">{a.kind}</p>
              ...
              {a.allowance === "spend" && (
                <div className="mt-2">
                  <label className="font-jetbrains text-[10px] tracking-[0.14em] text-white/35 uppercase" htmlFor={`trade-${a.id}`}>
                    trade
                    <span
                  ...
                  <input
                    ...
                    className="font-hanken mt-1 w-full rounded-lg border border-white/12 bg-white/[0.03] px-2 py-1 text-[12px] text-slate-200 placeholder:text-white/25"
                  />
                </div>
              )}
            </li>
